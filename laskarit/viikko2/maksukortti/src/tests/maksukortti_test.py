...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_syoda_edullisesti_kun_saldo_edullisen_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_syoda_maukkaasti_kun_saldo_maukkaan_lounaan_verran(self):
