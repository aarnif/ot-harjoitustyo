class User:
    ...
    Attributes:
        ...
        weekly_training_goal_in_minutes (int): Käyttäjän viikoittainen 
        treenitavoite minuutteina.
    """
    ...
    def __init__(self, username, password, weekly_training_goal_in_minutes=0):
        ...
        Args:
            username (str): Käyttäjänimi
            password (str): Käyttäjän salasana
            weekly_training_goal_in_minutes (int, optional): Käyttäjän viikoittainen 
            treenitavoite minuutteina. Oletusarvo 0.
        """
