...
class CreateUserView:
    ...
    def _initialize(self):
        ...
        header_label = ttk.Label(
            master=self._frame, text="Create User", font=("", 12, "bold"))
        ...
        username_label = ttk.Label(
            master=self._frame, text="Username", anchor="w")
        username_entry = ttk.Entry(master=self._frame)

        password_label = ttk.Label(
            master=self._frame, text="Password", anchor="w")
        password_entry = ttk.Entry(master=self._frame, show="*",)

        confirm_password_label = ttk.Label(
            master=self._frame, text="Confirm Password", anchor="w")
        ...
        go_back_button = ttk.Button(
            master=self._frame, text="Go Back", command=self._handle_show_login)
        create_button = ttk.Button(
            master=self._frame, text="Create", command=self._handle_create_user)

        header_label.grid(columnspan=1, sticky=constants.W,
                          padx=(10, 0), pady=5)
        ...
        username_label.grid(
            row=1, column=0, sticky=constants.W, padx=(10, 0), pady=5)
        username_entry.grid(row=1, column=1, sticky=(
            constants.E, constants.W), padx=(5, 10), pady=5)

        password_label.grid(
            row=2, column=0, sticky=constants.W, padx=(10, 0), pady=5)
        password_entry.grid(row=2, column=1, sticky=(
            constants.E, constants.W), padx=(5, 10), pady=5)

        confirm_password_label.grid(
            row=3, column=0, sticky=constants.W, padx=(10, 0), pady=5)
        confirm_password_entry.grid(row=3, column=1, sticky=(
            constants.E, constants.W), padx=(5, 10), pady=5)

        create_button.grid(row=4, column=1, sticky=(
            constants.E, constants.W), padx=(5, 10), pady=5)
        go_back_button.grid(row=5, column=1, sticky=(
            constants.E, constants.W), padx=(5, 10), pady=5)
