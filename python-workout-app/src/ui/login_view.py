...
class LoginView:
    ...
    def _initialize(self):
        ...
        header_label = ttk.Label(master=self._frame, text="Login", font=("", 12, "bold"))
        ...
        create_user_button = ttk.Button(master=self._frame, text="Create User", command=self._handle_show_create_user)
        ...
        login_button.grid(row=3, column=1, sticky=(constants.E, constants.W), padx=(5, 10), pady=5)
        create_user_button.grid(row=4, column=1, sticky=(constants.E, constants.W), padx=(5, 10), pady=5)
